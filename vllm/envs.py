...
if TYPE_CHECKING:
    ...
    VLLM_DISABLE_KIMI_K3_LOW_LATENCY_GEMM: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Disable the AMD gfx950 Kimi-K3 low-latency skinny-GEMM dispatch
    # (wvSplitK/wvSplitKrc), falling back to the standard unquantized GEMM.
    "VLLM_DISABLE_KIMI_K3_LOW_LATENCY_GEMM": lambda: bool(
        int(os.getenv("VLLM_DISABLE_KIMI_K3_LOW_LATENCY_GEMM", "0"))
    ),
